<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="AdminForgotPW2.aspx.cs" Inherits="WebApplication22.AdminForgotPW2" %>
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                      ...
                      <div class="form-group">
                          <asp:RequiredFieldValidator ValidationGroup='valGroup15' ID="RequiredFieldValidator7" runat="server" ErrorMessage="Required" ControlToValidate="TextBox1" ForeColor="Red"></asp:RequiredFieldValidator>              
                      ...
                      <asp:Button ID="Button1" ValidationGroup='valGroup15' class="btn btn-lg btn-danger btn-block" runat="server" Text="Display password" OnClick="Button1_Click1" />
                      </div>
                        <p><center><b>
